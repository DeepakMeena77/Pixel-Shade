...
const SEED_CLIENTS = [
    { name: 'OSO Real Estates',         tagline: 'Where Every Home Tells a Story',                   industry: 'Real Estate',           logo_url: '/logos/logo-oso-real-estates.png',         color: '#0ea5e9', bg: 'from-sky-50 to-blue-50',       border_class: 'border-sky-200',      badge_class: 'bg-sky-100 text-sky-700',        dark: false, sort_order: 0 },
    { name: 'Vivah Utshav',             tagline: 'Turning Dream Weddings Into Timeless Memories',    industry: 'Wedding Solutions',     logo_url: '/logos/logo-vivah-utshav.png',             color: '#b45309', bg: 'from-amber-50 to-rose-50',     border_class: 'border-amber-200',    badge_class: 'bg-amber-100 text-amber-700',    dark: false, sort_order: 1 },
    { name: 'VL Boutique',              tagline: 'Style That Speaks Before You Do',                  industry: 'Fashion & Apparel',     logo_url: '/logos/logo-vl-boutique.png',              color: '#ec4899', bg: 'from-pink-50 to-orange-50',    border_class: 'border-pink-200',     badge_class: 'bg-pink-100 text-pink-700',      dark: false, sort_order: 2 },
    { name: 'AmlaCubes',                tagline: 'Nature\'s Power, Cubed to Perfection',              industry: 'Health & Wellness',     logo_url: '/logos/logo-amla-cubes.png',               color: '#16a34a', bg: 'from-green-50 to-emerald-50',  border_class: 'border-green-200',    badge_class: 'bg-green-100 text-green-700',    dark: false, sort_order: 3 },
    { name: 'MR Realty Talks',          tagline: 'Turning Properties Into Profits',                  industry: 'Real Estate',           logo_url: '/logos/logo-mr-realty-talks.png',          color: '#f59e0b', bg: 'from-yellow-50 to-gray-100',   border_class: 'border-yellow-300',   badge_class: 'bg-yellow-100 text-yellow-700',  dark: false, sort_order: 4 },
    { name: 'D Boutique',               tagline: 'Elegance Is Always In Season',                     industry: 'Bridal Fashion',        logo_url: '/logos/logo-d-boutique.png',               color: '#7c3aed', bg: 'from-purple-50 to-pink-50',    border_class: 'border-purple-200',   badge_class: 'bg-purple-100 text-purple-700',  dark: false, sort_order: 5 },
    { name: 'MS Cell Point',            tagline: 'Your One-Stop Destination for Premium Gadgets',    industry: 'Electronics & Tech',    logo_url: '/logos/logo-ms-cell-point.png',            color: '#ca8a04', bg: 'from-gray-900 to-gray-800',    border_class: 'border-yellow-500/40', badge_class: 'bg-yellow-900/30 text-yellow-400', dark: true,  sort_order: 6 },
    { name: 'House of Maha',            tagline: 'Drape Yourself in Culture and Grace',              industry: 'Ethnic Wear',           logo_url: '/logos/logo-house-of-maha.png',            color: '#b91c1c', bg: 'from-red-50 to-amber-50',      border_class: 'border-red-200',      badge_class: 'bg-red-100 text-red-700',        dark: false, sort_order: 7 },
    { name: '1Z Realty',                tagline: 'Homes · Investments · Trust',                      industry: 'Real Estate',           logo_url: '/logos/logo-1z-realty.png',                color: '#ca8a04', bg: 'from-gray-900 to-gray-800',    border_class: 'border-yellow-500/40', badge_class: 'bg-yellow-900/30 text-yellow-400', dark: true,  sort_order: 8 },
    { name: 'Astrologer Ramaraju',      tagline: 'Ancient Wisdom, Timeless Guidance',                industry: 'Astrology & Spirituality', logo_url: '/logos/logo-astrologer-ramaraju.png',   color: '#92400e', bg: 'from-amber-50 to-yellow-50',   border_class: 'border-amber-300',    badge_class: 'bg-amber-100 text-amber-800',    dark: false, sort_order: 9 },
    { name: 'Sri Mahalakshmi Traders',  tagline: 'Building the Future, Block by Block',              industry: 'Hardware & Cement',     logo_url: '/logos/logo-sri-mahalakshmi-traders.png',  color: '#1d4ed8', bg: 'from-blue-50 to-indigo-50',    border_class: 'border-blue-200',     badge_class: 'bg-blue-100 text-blue-700',      dark: false, sort_order: 10 },
    { name: 'Moofreshmilk',             tagline: 'Fresh From Nature, Delivered With Care',           industry: 'Dairy & Food',          logo_url: '/logos/logo-moofreshmilk.png',             color: '#15803d', bg: 'from-green-50 to-lime-50',     border_class: 'border-green-300',    badge_class: 'bg-green-100 text-green-700',    dark: false, sort_order: 11 },
    { name: 'Divya Jewelers',           tagline: 'Where Gold Meets Glory',                           industry: 'Jewellery',             logo_url: '/logos/logo-divya-jewelers.png',           color: '#b45309', bg: 'from-gray-900 to-gray-800',    border_class: 'border-yellow-500/50', badge_class: 'bg-yellow-900/40 text-yellow-400', dark: true,  sort_order: 12 },
    { name: 'Avigna',                   tagline: 'Wrap Yourself in Tradition, Walk in Style',         industry: 'Sarees & Dress',        logo_url: '/logos/logo-avigna.png',                   color: '#db2777', bg: 'from-pink-50 to-rose-50',      border_class: 'border-pink-300',     badge_class: 'bg-pink-100 text-pink-700',      dark: false, sort_order: 13 },
]
